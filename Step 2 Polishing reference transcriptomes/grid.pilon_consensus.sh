...
# After last pilon round, merge the polished reference transcriptomes to generate one AlaNor.fasta file
...
cd $WORKDIR
sbatch --account=${ACCOUNT} ../pilon_consensus.sh Alaska $ROUND
sbatch --account=${ACCOUNT} ../pilon_consensus.sh Norway $ROUND
cd ..
