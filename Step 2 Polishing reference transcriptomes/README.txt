Polishing of Draba nivalis Alaska and Draba nivalis Norway reference transcriptomes using pilon.
...
Continue with making consensus_0, from Nowak et al. 2020 (Draba nivalis Alaska population) using Initial_mapping_to_ref.sh The original reference that was used is located in reference, where it has been renamed to ref.fasta.
